...
Je commence la détection en initialisant le moteur avec l'image voulue :

[CODE]

Je lance ensuite la détection :

[CODE]

L'objet GdPictureImaging contient les codes-barres détectés. La méthode de détection retourne une valeur de type GdPictureStatus qui indique si une erreur est survenue. Je n'ai pas eu à traiter de cas d'erreurs avec ces images dans la mesure ou il s'agit d'un jeu de test simple et éprouvé à plusieurs reprises.\\
